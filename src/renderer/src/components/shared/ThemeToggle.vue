...
<template>
  <label class="flex cursor-pointer items-center justify-between gap-2">
    <span class="text-xs text-slate-500 dark:text-slate-400">Dark Mode</span>
    <input
      type="checkbox"
      class="peer sr-only"
    ...
    />
    <span
      class="relative h-5 w-9 shrink-0 rounded-full bg-slate-300 transition-colors peer-checked:bg-twitch-purple dark:bg-slate-700"
    >
      <span
